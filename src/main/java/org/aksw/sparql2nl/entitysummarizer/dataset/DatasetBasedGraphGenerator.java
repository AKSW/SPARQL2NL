...
public class DatasetBasedGraphGenerator {
	...
	public DatasetBasedGraphGenerator(SparqlEndpoint endpoint, CacheFrontend frontend) {
		...
		reasoner = new SPARQLReasoner(new SparqlEndpointKS(endpoint), frontend);
	...
	private void init(){
		CacheFrontend frontend = CacheUtilsH2.createCacheFrontend("sparql", true, TimeUnit.DAYS.toMillis(30));
		qef = new QueryExecutionFactoryCacheEx(qef, frontend);
